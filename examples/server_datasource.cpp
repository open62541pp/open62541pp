...
int main() {
    ...
    dataSource.read = [&](opcua::NodeId id, opcua::DataValue& value, const opcua::NumericRange&, bool timestamp) {
    ...
    dataSource.write = [&](opcua::NodeId id, const opcua::DataValue& value, const opcua::NumericRange&) {
