...
int main() {
    ...
    dataSource.read = [&](const opcua::NodeId&, opcua::DataValue& dv, const opcua::NumericRange&, bool timestamp) {
    ...
    dataSource.write = [&](const opcua::NodeId& id, const opcua::DataValue& dv, const opcua::NumericRange&) {
