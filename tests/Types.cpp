...
TEST_CASE("NodeAttributes") {
    ...
    SUBCASE("Cast type") {
        ...
        CHECK(attr.getSpecifiedAttributes().get() == UA_NODEATTRIBUTESMASK_VALUERANK);
    }

    SUBCASE("Wrapper type") {
        attr.setDisplayName({"", "Name"});
        CHECK(attr.getDisplayName() == LocalizedText{"", "Name"});
        CHECK(attr.getSpecifiedAttributes().get() == UA_NODEATTRIBUTESMASK_DISPLAYNAME);
    }
    ...
    SUBCASE("Array type") {
        ...
        CHECK(attr.getSpecifiedAttributes().get() == UA_NODEATTRIBUTESMASK_ARRAYDIMENSIONS);
    }
}
